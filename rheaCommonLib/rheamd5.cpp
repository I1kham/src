...
//////////////////////////////////////////////
MD5::MD5 (const void *in, u32 sizeofin)
{
  init();
  update((const u8*)in, sizeofin);
  finalize();
}
...
void MD5::update(const u8 *input, size_type length)
{
...
void MD5::hexdigest(char *out, u32 sizeofout) const
{
    out[0] = 0x00;
    if (finalized)
    {
